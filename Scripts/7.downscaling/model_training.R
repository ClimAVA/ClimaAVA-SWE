...
# getwd()
# setwd("/scratch/general/vast/u6055107/climava_swe/future/training")
# 
# for (m in 1:15){ # models 2 and 17
#   model <- models[m,1]
#   print(model)
#   dir.create(model)
# 
...
for (v in 1){ #trains all 3 variables
  ...
  #m=8
  for(m in 12) { #2 and 17 # validation is for the finer (1) and (coarser) GCMs
    ...
    nc2 <- nc_open(paste0("/scratch/general/vast/u6055107/climava_swe/reference/stacked/swe_west_stack_1992-2001.nc"))
    nc3 <- nc_open(paste0("/scratch/general/vast/u6055107/climava_swe/reference/stacked/swe_west_stack_2002-2011.nc"))
    nc4 <- nc_open(paste0("/scratch/general/vast/u6055107/climava_swe/reference/stacked/swe_west_stack_2012-2023.nc"))
             ...
             .packages = c("spam","doParallel","foreach","ncdf4","dplyr", "randomForest", "Metrics")) %dopar% {
               ...
               if (IN_OUT == 1){
                 ...
                 if (tem_up == FALSE | tem_down == FALSE){
                   ...
                   # taking the values from the years we aim to train (1982-2023)
                   var_1 <- array1[X_var,Y_var,1:3652]
                   var_2 <- array2[X_var,Y_var,1:3653]
                   var_3 <- array3[X_var,Y_var,1:3652]
                   var_4 <- array4[X_var,Y_var,1:4383]
                   
                   
                   
                   #put all data together as one vector
                   VAR <- c(var_1, var_2,var_3,var_4)
                  ...
                  ############################################################################
                   ...
                   rm(rf_model_down,rf_model_up, grid_lon, grid_lat, dist, row, var_1, var_2,var_3, var_4,
