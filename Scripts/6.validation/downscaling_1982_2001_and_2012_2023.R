...
files <- read.csv("/uufs/chpc.utah.edu/common/home/u6055107/Documents/codes/climava_swe/excels/files_validation_1982_2001_and_2012_2023.csv")

#########################################################################
#####Creating directories--------
# getwd()
# setwd("/scratch/general/vast/u6055107/climava_swe/validation/downscaling/1982_2001_and_2012_2023")
# 
...
for (v in 1){ #downscaling all 3 variables
  ...
  for(m in c(1,13)) { #2 and 17
    ...
    for (f in 1:3){ #it goes through years from 1981 to 2010
      ...
      nc_name <- paste0("/scratch/general/vast/u6055107/climava_swe/validation/downscaling/1982_2001_and_2012_2023/",model,"/swe_validation_",model,"_",dates,".nc")
        ...
        data <- foreach (i= 1:length(grid$id),  #1:96806 is the total number of pixel for the area of interest
                         .packages = c("spam","doParallel","foreach","ncdf4","dplyr", "randomForest", "Metrics")) %dopar% {
                           ...
                           if (IN_OUT == 1){
                             ...
                             model_name_up <- paste0("/scratch/general/vast/u6055107/climava_swe/validation/training/1982_2001_and_2012_2023/",model,"/rf_up_",ID,"_",model,"_",var,".rds")
                             model_name_down <-paste0("/scratch/general/vast/u6055107/climava_swe/validation/training/1982_2001_and_2012_2023/",model,"/rf_down_",ID,"_",model,"_",var,".rds")
