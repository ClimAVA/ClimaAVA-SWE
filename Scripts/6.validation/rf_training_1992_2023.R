...
# getwd()
# setwd("/scratch/general/vast/u6055107/climava_swe/validation/training/1992_2023")
# 
...
for (v in 1){ #trains all 3 variables
  ...
  for(m in c(1,13)) { #2 and 17 # validation is for the finer (1) and (coarser) GCMs
    ...
    nc1 <- nc_open(paste0("/scratch/general/vast/u6055107/climava_swe/reference/stacked/swe_west_stack_1992-2001.nc"))
             ...
             .packages = c("spam","doParallel","foreach","ncdf4","dplyr", "randomForest", "Metrics")) %dopar% {
               ...
               if (IN_OUT == 1){
                 ...
                 if (tem_up == FALSE | tem_down == FALSE){
                   ...
                   var_1 <- array1[X_var,Y_var,1:3653]
