...
# getwd()
# setwd("/scratch/general/vast/u6055107/climava_swe/validation/training/1982_2011")
# 
    ...
    foreach (i = 1:233022,  #foreach package used because of parallel process
             .packages = c("spam","doParallel","foreach","ncdf4","dplyr", "randomForest", "Metrics")) %dopar% {
               ...
               if (IN_OUT == 1){
                 ...
                 model_name_up <- paste0("/scratch/general/vast/u6055107/climava_swe/validation/training/1982_2011/",model,"/rf_up_",ID,"_",model,"_",var,".rds")
                 model_name_down <-paste0("/scratch/general/vast/u6055107/climava_swe/validation/training/1982_2011/",model,"/rf_down_",ID,"_",model,"_",var,".rds")
